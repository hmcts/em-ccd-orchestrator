...
public class CcdBundleCloningServiceTest {
    ...
    private void checkBundleTitle(ArrayNode list, int i, String title) throws Exception {
    ...
    public void testNameUpdated() throws Exception {
        ...
        checkBundleTitle(updatedBundles, 0, "First Bundle");
        checkBundleTitle(updatedBundles, 1, "CLONED First Bundle");
    }
    ...
    public void testAllEligibleBundlesCloned() throws Exception {
        ...
        checkBundleTitle(updatedBundles, 0, "First Bundle");
        checkBundleTitle(updatedBundles, 1, "CLONED First Bundle");
        checkBundleTitle(updatedBundles, 2, "Second Bundle");
        checkBundleTitle(updatedBundles, 3, "CLONED Second Bundle");
    }
