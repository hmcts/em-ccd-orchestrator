...
public class CcdCaseDataContentTest {
    ...
    public void testProperties() {
        ...
        assertEquals("CcdCaseDataContent(event=CcdEvent(eventId=eventx), data=null, eventData=null, securityClassification=x, dataClassification=null, token=token, ignoreWarning=true, draftId=draftId, caseReference=x)", ccdCaseDataContent.toString());
