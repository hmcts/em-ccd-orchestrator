...
public class SecureAutomatedBundlingScenarios extends BaseTest {
    ...
    public void testCorruptConfig() {
        ...
        response
                ...
                .body("errors[0]", equalTo("Invalid configuration file entry in:"
                    + " test-files/example-incorrect-key.yaml; Configuration file parameter(s) and/or parameter value(s)"));
    }
    ...
    public void testAddFlatFilteredDocuments() throws Exception {
        String json = TestUtil.readFile("src/aat/resources/documents-case.json");
        json = json.replaceAll("configurationFile", "test-files/f-tests-2-filter-flat-docs.yaml");
        json = findDocumentUrl(json);
    ...
    public void testAddFolderedDocuments() throws Exception {
        String json = TestUtil.readFile("src/aat/resources/documents-case.json");
        json = json.replaceAll("configurationFile", "test-files/f-tests-3-foldered-docs.yaml");
        json = findDocumentUrl(json);
    ...
    public void testAddFilteredFolderedDocuments() throws Exception {
        String json = TestUtil.readFile("src/aat/resources/documents-case.json");
        json = json.replaceAll("configurationFile", "test-files/f-tests-4-filtered-foldered-docs.yaml");
        json = findDocumentUrl(json);
    ...
    public void testTypoInConfigurationFile() throws IOException {
        String json = TestUtil.readFile("src/aat/resources/documents-case.json");
        json = json.replaceAll("configurationFile", "test-files/f-tests-6-has-typo.yaml");
        ...
        response.assertThat()
                .log().all()
                .statusCode(400)
                .body("errors", contains("Invalid configuration file entry in: test-files/f-tests-6-has-typo.yaml; "
                        + "Configuration file parameter(s) and/or parameter value(s)"));
    }
    ...
    public void testDocumentNotPresent() throws Exception {
        String json = TestUtil.readFile("src/aat/resources/documents-case.json");
        json = json.replaceAll("configurationFile", "test-files/f-tests-12-invalid-document-property.yaml");
        json = findDocumentUrl(json);
    ...
    public void testDocumentPropertyIsAnArray() throws IOException {
        String json = TestUtil.readFile("src/aat/resources/documents-case.json");
        json = json.replaceAll("configurationFile", "test-files/f-tests-7-not-a-single-doc.yaml");
    ...
    public void testDocumentSetPropertyIsNotAnArray() throws IOException {
        String json = TestUtil.readFile("src/aat/resources/documents-case.json");
        json = json.replaceAll("configurationFile", "test-files/f-tests-8-not-an-array.yaml");
    ...
    public void testDocumentStructureCorrupted() throws IOException {
        ...
        json = json.replaceAll("configurationFile", "test-files/f-tests-5-invalid-url.yaml");
    ...
    public void testMultipleFilters() throws Exception {
        String json = TestUtil.readFile("src/aat/resources/documents-case.json");
        json = json.replaceAll("configurationFile", "test-files/f-tests-9-multiple-filters.yaml");
        json = findDocumentUrl(json);
    ...
    public void testSortDocumentsAscending() throws Exception {
        String json = TestUtil.readFile("src/aat/resources/documents-case.json");
        json = json.replaceAll("configurationFile", "test-files/f-tests-10-sorting.yaml");
        json = findDocumentUrl(json);
    ...
    public void testSortDocumentsDescending() throws Exception {
        String json = TestUtil.readFile("src/aat/resources/documents-case.json");
        json = json.replaceAll("configurationFile", "test-files/f-tests-11-sorting.yaml");
        json = findDocumentUrl(json);
    ...
    public void testRenderImageInStitchedDocument() throws Exception {
        String json = TestUtil.readFile("src/aat/resources/documents-case.json");
        json = json.replaceAll("configurationFile", "test-files/f-tests-13-render-image-flat-docs.yaml");
        json = findDocumentUrl(json);
