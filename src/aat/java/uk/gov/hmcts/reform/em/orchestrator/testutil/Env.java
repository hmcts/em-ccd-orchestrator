...
public final class Env {
    ...
    static {
        ...
        defaults.setProperty("MANUAL_CCD_DEF_FILE_IMPORT", "false");
    ...
    public static boolean isManualCcdDefFileImport() {
        return new Boolean(require("MANUAL_CCD_DEF_FILE_IMPORT"));
    }
